...
- Human URL: `https://araminta.taild3f7b9.ts.net/pirate/`
...
4. Keep Tailscale Funnel path `/pirate` pointed at `6081`; do not rely on stale helper ports or overwrite unrelated root routes.
